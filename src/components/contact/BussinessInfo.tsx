  ...
  return (
    <div className="flex flex-col gap-6 px-6 mb-12 md:w-[500px] md:mx-auto">
      ...
      <p className="text-button text-center md:text-left">
        ...
        mercado cubano.
        <br />
        Surge en enero del 2022, como resultado del deseo profundo de satisfacer
        las necesidades en dicho mercado, apostando siempre al crecimiento y
        profesionalidad. Abarcando diferentes nichos sólidamente, hemos logrado
        convertirnos en una gran oportunidad para nuestros clientes, ofreciendo
      ...
      <div className="flex flex-col gap-4 text-center md:text-left">
        ...
        <p className="font-bold text-button">
          ...
          <span className="font-normal text-button">
            ...
            respetado en Cuba. Con un stock estable, de fácil alcance y precios
            altamente competitivos. Ofrecer un servicio de venta y postventa de
            excelencia. cubano.
          </span>
        </p>
        <p className="font-bold text-button">
